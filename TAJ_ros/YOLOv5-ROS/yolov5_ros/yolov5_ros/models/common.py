...
from yolov5_ros.utils import TryExcept
from yolov5_ros.utils.dataloaders import exif_transpose, letterbox
...
from yolov5_ros.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        pt, jit, onnx, xml, engine, coreml, saved_model, pb, tflite, tfjs, paddle, triton = self._model_type(w)
        fp16 &= pt or jit or onnx or engine or triton  # FP16
        nhwc = coreml or saved_model or pb or tflite  # BHWC formats (vs torch BCWH)
